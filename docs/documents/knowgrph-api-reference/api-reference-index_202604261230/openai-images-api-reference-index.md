...
Edit image parameters, response objects, and additional API details continue in [openai-images-api-reference-index.companion.md](openai-images-api-reference-index.companion.md).
