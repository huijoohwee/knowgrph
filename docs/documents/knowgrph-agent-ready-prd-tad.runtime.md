...
- no published or remote mutation tools; browser WebMCP mutation is limited to the four guarded
  local Camera, Animation, Motion Control, and XR scene controls declared by the shared contract
