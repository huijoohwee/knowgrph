...
| Context              | Intent                          | Directive                                                                                   | Module       | Class/Object  | Function/Method     | Dependency        | Input                        | Output                 | Decision Logic                   |
|----------------------|---------------------------------|---------------------------------------------------------------------------------------------|--------------|---------------|---------------------|-------------------|------------------------------|------------------------|----------------------------------|
| Panel Resize         | Adjust layout dynamically       | - [ ] Throttle resize events; update dimensions; forbid layout thrashing                  | BottomPanel  | ResizeMgr     | handleResize        | lodash            | Resize event                 | Updated dimensions     | throttle(handler, 100ms)         |
