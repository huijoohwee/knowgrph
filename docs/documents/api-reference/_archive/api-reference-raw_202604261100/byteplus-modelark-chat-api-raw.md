...
This topic describes the request and response parameters of the API for calling text generation and visual understanding models.
:::tip tip
...
> If you want to use access key authentication, we recommend that you use the SDK. For more information, refer to [SDK overview](https://docs.byteplus.com/en/docs/ModelArk/1541595).
