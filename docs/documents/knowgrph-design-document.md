...
1. **Author and ingest**: Markdown is ingested and normalized into a parseable form. `docs/workspace-readme.md` owns the public Live Canvas Hero's editorial model, while `agentic-canvas-os/docs/workspace-seeds/knowgrph-physics-playground-demo.md` owns its canonical interactive startup canvas.
