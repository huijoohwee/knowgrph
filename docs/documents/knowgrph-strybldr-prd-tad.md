...
| Camera, XR, and Timeline projections | `canvas/src/features/strybldr/StrybldrCameraFloatingPanelView.tsx`, `canvas/src/features/three/XrPanelView.tsx`, `canvas/src/features/gitgraph/TimelineBottomPanelView.tsx`, `canvas/src/features/three/XrTimelineSceneLane.tsx` | Keep Camera and XR as distinct FloatingPanel panels while mounting the camera editor only in Camera; XR motion, Scene, and Runtime reuse the canonical BottomPanel Timeline player, and no duplicate camera editor, standalone XR player, or dedicated BottomPanel XR route remains. |
