...
| `bipartite.metric.nodeGlow` | string | store |  |  |
| `bipartite.metric.nodePulse` | string | store |  |  |
| `bipartite.metric.nodeBorder` | string | store |  |  |
| `bipartite.metric.edgeOpacity` | string | store |  |  |
| `bipartite.show.specificityBadges` | boolean | store |  |  |
| `bipartite.show.gapScoreInLabel` | boolean | store |  |  |
| `bipartite.show.clusterGapRatio` | boolean | store |  |  |
