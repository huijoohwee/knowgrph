...
export const KTV_ROW_VALUE_CELL_CLASS_NAME = `${KTV_ROW_TEXT_CELL_CLASS_NAME} gap-2 justify-start sm:justify-end ${UI_THEME_TOKENS.text.secondary}`
...
export const KTV_KEY_TYPE_VALUE_GRID_CLASS_NAME = 'grid-cols-[minmax(0,0.92fr)_minmax(3.75rem,0.62fr)_minmax(0,1fr)] sm:grid-cols-[minmax(0,1.05fr)_minmax(5rem,6.75rem)_minmax(0,1.25fr)]'
