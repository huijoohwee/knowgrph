...
} from '@/features/storyboard-widget-manager/spec/specValidation'
import {
  readFlowNodeSpecFromStorage,
  readFlowWorkflowSpecFromStorage,
  writeFlowNodeSpecToStorage,
  writeFlowWorkflowSpecToStorage,
} from '@/features/storyboard-widget-manager/spec/specStorage'

type SpecTab = 'node' | 'workflow'

export default function StoryboardWidgetSpecificationTab({
  onRegisterActions,
}: {
  ...
  return (
    <section className="h-full min-h-0 flex flex-col" aria-label="Storyboard Widget Specification">
