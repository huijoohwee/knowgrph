...
export const AGENTIC_OS_COMMAND_INVOCATIONS: readonly AgenticOsDictionaryInvocation[] = [
  ...
  buildAgenticOsDictionaryInvocation({ kind: 'command', token: '/sandbox.policy.validate', label: 'Sandbox policy validate', group: 'Agentic OS command dictionary', summary: 'Compile and audit one source-backed native agent sandbox policy.', dictionaryFileName: 'DICTIONARY-COMMAND.md', keywords: ['sandbox', 'policy', 'validate', 'deny first'] }),
  buildAgenticOsDictionaryInvocation({ kind: 'command', token: '/sandbox.policy.authorize', label: 'Sandbox policy authorize', group: 'Agentic OS command dictionary', summary: 'Return one fail-closed preflight decision without executing the operation.', dictionaryFileName: 'DICTIONARY-COMMAND.md', keywords: ['sandbox', 'policy', 'authorize', 'preflight'] }),
  ...
  buildAgenticOsDictionaryInvocation({ kind: 'command', token: '/canvas.node.add', label: 'Canvas node add', group: 'Agentic OS command dictionary', summary: 'Create a graph node through existing Canvas owners at the resolved canvas insertion point.', dictionaryFileName: 'DICTIONARY-COMMAND.md', keywords: ['canvas node', 'add node', 'create node', 'canvas center'] }),
  buildAgenticOsDictionaryInvocation({ kind: 'command', token: '/canvas.node.link', label: 'Canvas node link', group: 'Agentic OS command dictionary', summary: 'Start or commit a node-to-node connection through the shared Canvas edge request flow.', dictionaryFileName: 'DICTIONARY-COMMAND.md', keywords: ['canvas node', 'edge request', 'connect node', 'selected node'] }),
  buildAgenticOsDictionaryInvocation({ kind: 'command', token: '/canvas.selection.open', label: 'Canvas selection open', group: 'Agentic OS command dictionary', summary: 'Open the selected node or edge in the shared side panel, tab, editor, or markdown provenance surface.', dictionaryFileName: 'DICTIONARY-COMMAND.md', keywords: ['canvas selection', 'open node', 'open edge', 'markdown provenance'] }),
  buildAgenticOsDictionaryInvocation({ kind: 'command', token: '/canvas.selection.chat', label: 'Canvas selection chat', group: 'Agentic OS command dictionary', summary: 'Append selected node or edge context to FloatingPanel Chat through the existing chat append route.', dictionaryFileName: 'DICTIONARY-COMMAND.md', keywords: ['canvas selection', 'add to chat', 'selected node', 'selected edge'] }),
  buildAgenticOsDictionaryInvocation({ kind: 'command', token: '/canvas.selection.delete', label: 'Canvas selection delete', group: 'Agentic OS command dictionary', summary: 'Request deletion of the selected Canvas record through the shared graph mutation owner.', dictionaryFileName: 'DICTIONARY-COMMAND.md', keywords: ['canvas selection', 'delete node', 'graph mutation', 'operator approval'] }),
  buildAgenticOsDictionaryInvocation({ kind: 'command', token: '/canvas.media.attach', label: 'Canvas media attach', group: 'Agentic OS command dictionary', summary: 'Add or update selected-node media metadata through the shared media property owner.', dictionaryFileName: 'DICTIONARY-COMMAND.md', keywords: ['canvas media', 'media url', 'rich media', 'node media'] }),
  buildAgenticOsDictionaryInvocation({ kind: 'command', token: '/canvas.layout.tune', label: 'Canvas layout tune', group: 'Agentic OS command dictionary', summary: 'Tune or reset schema-owned Canvas layout mode and forces through the graph schema owner.', dictionaryFileName: 'DICTIONARY-COMMAND.md', keywords: ['canvas layout', 'layout mode', 'layout forces', 'anti-line', 'post-fit', AGENTIC_OS_CANVAS_INTERACTION_PANEL_KEYWORD] }),
  buildAgenticOsDictionaryInvocation({ kind: 'command', token: '/canvas.viewport.inspect', label: 'Canvas viewport inspect', group: 'Agentic OS command dictionary', summary: 'Read the current viewport size, zoom, center, and transform through shared zoom/projection owners.', dictionaryFileName: 'DICTIONARY-COMMAND.md', keywords: ['canvas viewport', 'viewport readout', 'zoom percent', 'transform', AGENTIC_OS_CANVAS_INTERACTION_PANEL_KEYWORD] }),
  buildAgenticOsDictionaryInvocation({ kind: 'command', token: '/canvas.viewport.transform', label: 'Canvas viewport transform', group: 'Agentic OS command dictionary', summary: 'Apply or audit viewport transform, zoom modes, wheel behavior, and speed tuning through shared camera owners.', dictionaryFileName: 'DICTIONARY-COMMAND.md', keywords: ['canvas viewport', 'zoom mode', 'wheel', 'speed', AGENTIC_OS_CANVAS_INTERACTION_PANEL_KEYWORD] }),
  buildAgenticOsDictionaryInvocation({ kind: 'command', token: '/canvas.interaction.tune', label: 'Canvas interaction tune', group: 'Agentic OS command dictionary', summary: 'Tune pointer mode, run mode, drag alpha target, and flow interaction behavior through existing canvas owners.', dictionaryFileName: 'DICTIONARY-COMMAND.md', keywords: ['canvas interaction', 'run mode', 'drag alpha target', 'flow', AGENTIC_OS_CANVAS_INTERACTION_PANEL_KEYWORD] }),
  buildAgenticOsDictionaryInvocation({ kind: 'command', token: '/canvas.physics.tune', label: 'Canvas physics tune', group: 'Agentic OS command dictionary', summary: 'Tune or reset schema-owned 2D physics forces without keeping panel-local slider state.', dictionaryFileName: 'DICTIONARY-COMMAND.md', keywords: ['canvas physics', 'physics 2d', 'velocity decay', 'drag charge', AGENTIC_OS_CANVAS_INTERACTION_PANEL_KEYWORD] }),
  buildAgenticOsDictionaryInvocation({ kind: 'command', token: '/canvas.center', label: 'Canvas center', group: 'Agentic OS command dictionary', summary: 'Center the viewport on the active selection or all items through shared arrange and centroid utilities.', dictionaryFileName: 'DICTIONARY-COMMAND.md', keywords: ['canvas center', 'centroid', 'center selection', 'center all', AGENTIC_OS_CANVAS_INTERACTION_PANEL_KEYWORD] }),
  buildAgenticOsDictionaryInvocation({ kind: 'command', token: '/canvas.distribute', label: 'Canvas distribute', group: 'Agentic OS command dictionary', summary: 'Distribute selected canvas items along an axis through shared arrange utilities.', dictionaryFileName: 'DICTIONARY-COMMAND.md', keywords: ['canvas distribute', 'even spread', 'horizontal', 'vertical', AGENTIC_OS_CANVAS_INTERACTION_PANEL_KEYWORD] }),
  buildAgenticOsDictionaryInvocation({ kind: 'command', token: '/canvas.performance.audit', label: 'Canvas performance audit', group: 'Agentic OS command dictionary', summary: 'Inspect render updates, state updates, layout timing, and performance overlay state through diagnostic owners.', dictionaryFileName: 'DICTIONARY-COMMAND.md', keywords: ['canvas performance', 'perf overlay', 'render updates', 'layout timing', AGENTIC_OS_CANVAS_INTERACTION_PANEL_KEYWORD] }),
  buildAgenticOsDictionaryInvocation({ kind: 'command', token: '/canvas.edge.rewire', label: 'Canvas edge rewire', group: 'Agentic OS command dictionary', summary: 'Update selected-edge source or target through the existing Canvas edge request flow.', dictionaryFileName: 'DICTIONARY-COMMAND.md', keywords: ['canvas edge', 'rewire edge', 'edge endpoint', 'selected edge'] }),
...
export const AGENTIC_OS_SEMANTIC_INVOCATIONS: readonly AgenticOsDictionaryInvocation[] = [
  ...
  buildAgenticOsDictionaryInvocation({ kind: 'semantic', token: '#canvas-node', label: 'Canvas node', group: 'Agentic OS semantic dictionary', summary: 'Canvas graph node selection, creation, opening, linking, or deletion intent.', dictionaryFileName: 'DICTIONARY-SEMANTIC.md', keywords: ['canvas', 'node', 'selection', 'graph'] }),
  buildAgenticOsDictionaryInvocation({ kind: 'semantic', token: '#canvas-edge', label: 'Canvas edge', group: 'Agentic OS semantic dictionary', summary: 'Canvas graph edge selection, creation, endpoint update, or provenance intent.', dictionaryFileName: 'DICTIONARY-SEMANTIC.md', keywords: ['canvas', 'edge', 'source', 'target'] }),
  buildAgenticOsDictionaryInvocation({ kind: 'semantic', token: '#canvas-media', label: 'Canvas media', group: 'Agentic OS semantic dictionary', summary: 'Media metadata, rich media panel, or media-node projection attached to Canvas graph state.', dictionaryFileName: 'DICTIONARY-SEMANTIC.md', keywords: ['canvas', 'media', 'rich media', 'node media'] }),
  buildAgenticOsDictionaryInvocation({ kind: 'semantic', token: '#canvas-layout', label: 'Canvas layout', group: 'Agentic OS semantic dictionary', summary: 'Schema-owned Canvas layout force tuning, preset, or reset intent.', dictionaryFileName: 'DICTIONARY-SEMANTIC.md', keywords: ['canvas', 'layout', 'forces', 'schema'] }),
  buildAgenticOsDictionaryInvocation({ kind: 'semantic', token: '#canvas-selection', label: 'Canvas selection', group: 'Agentic OS semantic dictionary', summary: 'Current Canvas node or edge selection used as the active invocation subject.', dictionaryFileName: 'DICTIONARY-SEMANTIC.md', keywords: ['canvas', 'selection', 'selected node', 'selected edge'] }),
  buildAgenticOsDictionaryInvocation({ kind: 'semantic', token: '#canvas-viewport', label: 'Canvas viewport', group: 'Agentic OS semantic dictionary', summary: 'Viewport readout, visible bounds, center point, or active camera state.', dictionaryFileName: 'DICTIONARY-SEMANTIC.md', keywords: ['canvas', 'viewport', 'readout', AGENTIC_OS_CANVAS_INTERACTION_PANEL_KEYWORD] }),
  buildAgenticOsDictionaryInvocation({ kind: 'semantic', token: '#canvas-transform', label: 'Canvas transform', group: 'Agentic OS semantic dictionary', summary: 'Zoom scale and screen-space translation for the active canvas viewport.', dictionaryFileName: 'DICTIONARY-SEMANTIC.md', keywords: ['canvas', 'transform', 'zoom scale', AGENTIC_OS_CANVAS_INTERACTION_PANEL_KEYWORD] }),
  buildAgenticOsDictionaryInvocation({ kind: 'semantic', token: '#canvas-zoom', label: 'Canvas zoom', group: 'Agentic OS semantic dictionary', summary: 'Zoom mode, zoom speed, fit-to-screen, or zoom-to-selection behavior.', dictionaryFileName: 'DICTIONARY-SEMANTIC.md', keywords: ['canvas', 'zoom', 'fit to screen', AGENTIC_OS_CANVAS_INTERACTION_PANEL_KEYWORD] }),
  buildAgenticOsDictionaryInvocation({ kind: 'semantic', token: '#canvas-wheel', label: 'Canvas wheel', group: 'Agentic OS semantic dictionary', summary: 'Wheel or trackpad gesture routing, speed, modifier boost, or overlay proxy behavior.', dictionaryFileName: 'DICTIONARY-SEMANTIC.md', keywords: ['canvas', 'wheel', 'trackpad', AGENTIC_OS_CANVAS_INTERACTION_PANEL_KEYWORD] }),
  buildAgenticOsDictionaryInvocation({ kind: 'semantic', token: '#canvas-interaction', label: 'Canvas interaction', group: 'Agentic OS semantic dictionary', summary: 'Pointer mode, run mode, interaction speed, drag behavior, or flow input behavior.', dictionaryFileName: 'DICTIONARY-SEMANTIC.md', keywords: ['canvas', 'interaction', 'run mode', AGENTIC_OS_CANVAS_INTERACTION_PANEL_KEYWORD] }),
  buildAgenticOsDictionaryInvocation({ kind: 'semantic', token: '#canvas-flow', label: 'Canvas flow', group: 'Agentic OS semantic dictionary', summary: 'Flow renderer wheel, selection, and overlay interaction behavior inside canvas surfaces.', dictionaryFileName: 'DICTIONARY-SEMANTIC.md', keywords: ['canvas', 'flow', 'overlay', AGENTIC_OS_CANVAS_INTERACTION_PANEL_KEYWORD] }),
  buildAgenticOsDictionaryInvocation({ kind: 'semantic', token: '#canvas-physics', label: 'Canvas physics', group: 'Agentic OS semantic dictionary', summary: 'Schema-owned 2D physics force, velocity, overlap, label, and drag tuning.', dictionaryFileName: 'DICTIONARY-SEMANTIC.md', keywords: ['canvas', 'physics 2d', 'forces', AGENTIC_OS_CANVAS_INTERACTION_PANEL_KEYWORD] }),
  buildAgenticOsDictionaryInvocation({ kind: 'semantic', token: '#canvas-centroid', label: 'Canvas centroid', group: 'Agentic OS semantic dictionary', summary: 'Centroid or center target for selected items, all items, or visible viewport fitting.', dictionaryFileName: 'DICTIONARY-SEMANTIC.md', keywords: ['canvas', 'centroid', 'center', AGENTIC_OS_CANVAS_INTERACTION_PANEL_KEYWORD] }),
  buildAgenticOsDictionaryInvocation({ kind: 'semantic', token: '#canvas-even-spread', label: 'Canvas even spread', group: 'Agentic OS semantic dictionary', summary: 'Even distribution of selected canvas items along a requested axis.', dictionaryFileName: 'DICTIONARY-SEMANTIC.md', keywords: ['canvas', 'even spread', 'distribute', AGENTIC_OS_CANVAS_INTERACTION_PANEL_KEYWORD] }),
  buildAgenticOsDictionaryInvocation({ kind: 'semantic', token: '#canvas-performance', label: 'Canvas performance', group: 'Agentic OS semantic dictionary', summary: 'Canvas render diagnostics, state update rate, layout timing, and performance overlay proof.', dictionaryFileName: 'DICTIONARY-SEMANTIC.md', keywords: ['canvas', 'performance', 'diagnostics', AGENTIC_OS_CANVAS_INTERACTION_PANEL_KEYWORD] }),
  ...
  buildAgenticOsDictionaryInvocation({ kind: 'semantic', token: '#agent-sandbox-policy', label: 'Agent sandbox policy', group: 'Agentic OS semantic dictionary', summary: 'Native deny-first policy for agent filesystem, process, network, credential, and audit decisions.', dictionaryFileName: 'DICTIONARY-SEMANTIC.md', keywords: ['sandbox', 'policy', 'credentials', 'egress'] }),
...
export const AGENTIC_OS_BINDING_INVOCATIONS: readonly AgenticOsDictionaryInvocation[] = [
  ...
  buildAgenticOsDictionaryInvocation({ kind: 'binding', token: '@selected-node', label: 'Selected node', group: 'Agentic OS binding dictionary', summary: 'Current Canvas node selection resolved through shared graph selection state.', dictionaryFileName: 'DICTIONARY-BINDING.md', keywords: ['selected node', 'canvas', 'node selection'] }),
  buildAgenticOsDictionaryInvocation({ kind: 'binding', token: '@selected-edge', label: 'Selected edge', group: 'Agentic OS binding dictionary', summary: 'Current Canvas edge selection resolved through shared graph selection state.', dictionaryFileName: 'DICTIONARY-BINDING.md', keywords: ['selected edge', 'canvas', 'edge selection'] }),
  buildAgenticOsDictionaryInvocation({ kind: 'binding', token: '@canvas-center', label: 'Canvas center', group: 'Agentic OS binding dictionary', summary: 'Resolved graph-space insertion point from the current visible Canvas viewport.', dictionaryFileName: 'DICTIONARY-BINDING.md', keywords: ['canvas center', 'viewport', 'insertion point'] }),
  buildAgenticOsDictionaryInvocation({ kind: 'binding', token: '@viewport-readout', label: 'Viewport readout', group: 'Agentic OS binding dictionary', summary: 'Current viewport size, zoom percent, and world-space center from shared viewport utilities.', dictionaryFileName: 'DICTIONARY-BINDING.md', keywords: ['viewport readout', 'zoom percent', 'center', AGENTIC_OS_CANVAS_INTERACTION_PANEL_KEYWORD] }),
  buildAgenticOsDictionaryInvocation({ kind: 'binding', token: '@viewport-transform', label: 'Viewport transform', group: 'Agentic OS binding dictionary', summary: 'Active zoom transform with scale and screen-space translation.', dictionaryFileName: 'DICTIONARY-BINDING.md', keywords: ['viewport transform', 'zoom scale', 'translation', AGENTIC_OS_CANVAS_INTERACTION_PANEL_KEYWORD] }),
  buildAgenticOsDictionaryInvocation({ kind: 'binding', token: '@zoom-mode', label: 'Zoom mode', group: 'Agentic OS binding dictionary', summary: 'Fit, selection, pinning, duration, and scale extent state for canvas zoom behavior.', dictionaryFileName: 'DICTIONARY-BINDING.md', keywords: ['zoom mode', 'fit to screen', 'selection duration', AGENTIC_OS_CANVAS_INTERACTION_PANEL_KEYWORD] }),
  buildAgenticOsDictionaryInvocation({ kind: 'binding', token: '@wheel-input', label: 'Wheel input', group: 'Agentic OS binding dictionary', summary: 'Wheel or trackpad behavior, modifier boost, and gesture preset context.', dictionaryFileName: 'DICTIONARY-BINDING.md', keywords: ['wheel input', 'trackpad', 'modifier boost', AGENTIC_OS_CANVAS_INTERACTION_PANEL_KEYWORD] }),
  buildAgenticOsDictionaryInvocation({ kind: 'binding', token: '@interaction-speed', label: 'Interaction speed', group: 'Agentic OS binding dictionary', summary: 'Pan, zoom, and global interaction speed multipliers.', dictionaryFileName: 'DICTIONARY-BINDING.md', keywords: ['interaction speed', 'pan speed', 'zoom speed', AGENTIC_OS_CANVAS_INTERACTION_PANEL_KEYWORD] }),
  buildAgenticOsDictionaryInvocation({ kind: 'binding', token: '@flow-run-mode', label: 'Flow run mode', group: 'Agentic OS binding dictionary', summary: 'Canvas run mode plus Flow wheel and overlay interaction state.', dictionaryFileName: 'DICTIONARY-BINDING.md', keywords: ['flow run mode', 'run mode', 'overlay wheel', AGENTIC_OS_CANVAS_INTERACTION_PANEL_KEYWORD] }),
  buildAgenticOsDictionaryInvocation({ kind: 'binding', token: '@drag-alpha-target', label: 'Drag alpha target', group: 'Agentic OS binding dictionary', summary: 'D3 drag alpha target used by the 2D simulation during canvas dragging.', dictionaryFileName: 'DICTIONARY-BINDING.md', keywords: ['drag alpha target', 'd3', 'simulation', AGENTIC_OS_CANVAS_INTERACTION_PANEL_KEYWORD] }),
  buildAgenticOsDictionaryInvocation({ kind: 'binding', token: '@media-url', label: 'Media URL', group: 'Agentic OS binding dictionary', summary: 'Approved media URL or inline media reference for node media metadata.', dictionaryFileName: 'DICTIONARY-BINDING.md', keywords: ['media url', 'rich media', 'node media'] }),
  buildAgenticOsDictionaryInvocation({ kind: 'binding', token: '@markdown-provenance', label: 'Markdown provenance', group: 'Agentic OS binding dictionary', summary: 'Document path and line range provenance for opening selected Canvas records in source.', dictionaryFileName: 'DICTIONARY-BINDING.md', keywords: ['markdown provenance', 'document path', 'line range'] }),
  buildAgenticOsDictionaryInvocation({ kind: 'binding', token: '@layout-forces', label: 'Layout forces', group: 'Agentic OS binding dictionary', summary: 'Schema-owned Canvas layout force values for anti-line and post-fit tuning.', dictionaryFileName: 'DICTIONARY-BINDING.md', keywords: ['layout forces', 'schema', 'anti-line', 'post-fit'] }),
  buildAgenticOsDictionaryInvocation({ kind: 'binding', token: '@physics-2d', label: 'Physics 2D', group: 'Agentic OS binding dictionary', summary: 'Schema-owned charge, collision, speed, overlap, label, and drag-force tuning for 2D layout.', dictionaryFileName: 'DICTIONARY-BINDING.md', keywords: ['physics 2d', 'forces', 'drag charge', AGENTIC_OS_CANVAS_INTERACTION_PANEL_KEYWORD] }),
  buildAgenticOsDictionaryInvocation({ kind: 'binding', token: '@centroid-target', label: 'Centroid target', group: 'Agentic OS binding dictionary', summary: 'Selection, all-items, or viewport target used by center and centroid arrange commands.', dictionaryFileName: 'DICTIONARY-BINDING.md', keywords: ['centroid target', 'center selection', 'center all', AGENTIC_OS_CANVAS_INTERACTION_PANEL_KEYWORD] }),
  buildAgenticOsDictionaryInvocation({ kind: 'binding', token: '@spread-axis', label: 'Spread axis', group: 'Agentic OS binding dictionary', summary: 'Requested horizontal or vertical axis for even-spread arrange operations.', dictionaryFileName: 'DICTIONARY-BINDING.md', keywords: ['spread axis', 'horizontal', 'vertical', AGENTIC_OS_CANVAS_INTERACTION_PANEL_KEYWORD] }),
  buildAgenticOsDictionaryInvocation({ kind: 'binding', token: '@performance-overlay', label: 'Performance overlay', group: 'Agentic OS binding dictionary', summary: 'Canvas performance overlay state and diagnostic readout source.', dictionaryFileName: 'DICTIONARY-BINDING.md', keywords: ['performance overlay', 'diagnostic readout', 'render updates', AGENTIC_OS_CANVAS_INTERACTION_PANEL_KEYWORD] }),
  buildAgenticOsDictionaryInvocation({ kind: 'binding', token: '@edge-endpoint', label: 'Edge endpoint', group: 'Agentic OS binding dictionary', summary: 'Candidate source or target endpoint for a Canvas edge request.', dictionaryFileName: 'DICTIONARY-BINDING.md', keywords: ['edge endpoint', 'source', 'target', 'canvas edge'] }),
  ...
  buildAgenticOsDictionaryInvocation({ kind: 'binding', token: '@sandbox-policy', label: 'Sandbox policy', group: 'Agentic OS binding dictionary', summary: 'Source-backed declarative policy identity and path for one agent runtime boundary.', dictionaryFileName: 'DICTIONARY-BINDING.md', keywords: ['sandbox', 'policy', 'source', 'boundary'] }),
