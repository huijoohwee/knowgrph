...
export const WORKFLOW_PRESETS: WorkflowPresetCatalogEntry[] = [
  {
    ...
    datasetFileName: EXAMPLES_BY_ID.sampleInvestorsTop3.datasetPath as WorkflowDatasetPath,
    schemaFileName: EXAMPLES_BY_ID.sampleInvestorsTop3.schemaPath as WorkflowSchemaPath,
    threeOverrides: {
  ...
  },
  {
    ...
    datasetFileName: EXAMPLES_BY_ID.aiKgViz.datasetPath as WorkflowDatasetPath,
    schemaFileName: EXAMPLES_BY_ID.aiKgViz.schemaPath as WorkflowSchemaPath,
    threeOverrides: {
      backgroundColor: '',
    },
  },
  {
    ...
    schemaFileName: EXAMPLES_BY_ID.aiCustomerVoiceManagement.schemaPath as WorkflowSchemaPath,
    threeOverrides: {
      backgroundColor: '',
    },
  },
  ...
  },
  {
    ...
    label: 'Demo: A0 Investors Knowledge Graph',
    parserId: toParserId('jsonld') as WorkflowPresetParserId,
    datasetFileName: EXAMPLES_BY_ID.a0Investors.datasetPath as WorkflowDatasetPath,
    schemaFileName: EXAMPLES_BY_ID.a0Investors.schemaPath as WorkflowSchemaPath,
  },
  {
