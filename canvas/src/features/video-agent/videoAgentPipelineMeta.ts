...
export const REASONING_META: Record<VideoAgentCapability, Omit<VideoAgentReasoningArtifact, 'capability'>> = {
  ingest: {
    ...
    outputArtifact: buildVideoAgentWorkspaceOutputPath('source.json'),
  ...
  parse: {
    ...
    outputArtifact: buildVideoAgentWorkspaceOutputPath('parse.json'),
  ...
  annotate: {
    ...
    outputArtifact: buildVideoAgentWorkspaceOutputPath('frame-boxes.json'),
  ...
  dataset: {
    ...
    outputArtifact: buildVideoAgentWorkspaceOutputPath('visual-dataset.json'),
  ...
  zone_count: {
    ...
    outputArtifact: buildVideoAgentWorkspaceOutputPath('zone-counts.json'),
  ...
  search: {
    ...
    outputArtifact: buildVideoAgentWorkspaceOutputPath('moments.json'),
  ...
  edit: {
    ...
    outputArtifact: buildVideoAgentWorkspaceOutputPath('edit-plan.json'),
  ...
  compile: {
    ...
    outputArtifact: buildVideoAgentWorkspaceOutputPath('render.html'),
  ...
  generate: {
    ...
    outputArtifact: buildVideoAgentWorkspaceOutputPath('generated-assets.json'),
  ...
  stream: {
    ...
    outputArtifact: buildVideoAgentWorkspaceOutputPath('stream-manifest.json'),
