...
export const uiGraphAndOrchestratorSettingsRegistryPart2: SettingMeta[] = [
  ...
  {
    key: 'storyboardWidgetSelectionOnDrag',
    type: 'boolean',
    source: 'store',
    read: () => s().storyboardWidgetSelectionOnDrag === true,
    write: (v) => s().setStoryboardWidgetSelectionOnDrag(Boolean(v)),
    docKey: 'storyboardWidgetSelectionOnDrag',
    default: () => false,
  },
  {
    key: 'storyboardWidgetOverlayWheelProxyEnabled',
    type: 'boolean',
    source: 'store',
    read: () => s().storyboardWidgetOverlayWheelProxyEnabled === true,
    write: (v) => s().setStoryboardWidgetOverlayWheelProxyEnabled(Boolean(v)),
    docKey: 'storyboardWidgetOverlayWheelProxyEnabled',
    default: () => true,
  },
  {
    key: 'viewPinned',
