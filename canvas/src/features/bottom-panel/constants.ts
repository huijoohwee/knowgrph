...
export const BOTTOM_PANEL_MARKDOWN_AUTO_OPEN_EVENT = 'kg:bottomPanelMarkdownAutoOpen'
export const BOTTOM_PANEL_MARKDOWN_OPEN_VIEWER_EVENT = 'kg:bottomPanelMarkdownOpenViewer'
