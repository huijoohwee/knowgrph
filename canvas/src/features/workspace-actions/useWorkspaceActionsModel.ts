...
export function useWorkspaceActionsModel(args?: { searchQuery?: string }) {
  ...
  const panelProps: ToolbarToolMenuAreasProps = {
    ...
    renderOpOk,
    renderOpMsg,
    isSourceFilesImportMenuOpen: menu.isSourceFilesImportMenuOpen,
    setIsSourceFilesImportMenuOpen: menu.setIsSourceFilesImportMenuOpen,
    isSourceFilesExportMenuOpen: menu.isSourceFilesExportMenuOpen,
    setIsSourceFilesExportMenuOpen: menu.setIsSourceFilesExportMenuOpen,
