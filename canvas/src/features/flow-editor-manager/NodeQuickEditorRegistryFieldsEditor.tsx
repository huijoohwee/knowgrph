...
import type { NodeQuickEditorRegistryField } from '@/features/flow-editor-manager/nodeQuickEditorRegistryTypes'

export default function NodeQuickEditorRegistryFieldsEditor({
  fields,
  onChange,
}: {
  fields: NodeQuickEditorRegistryField[]
  onChange: (next: NodeQuickEditorRegistryField[]) => void
}) {
