...
import type { NodeQuickEditorRegistrySchemaMapping } from '@/features/flow-editor-manager/nodeQuickEditorRegistryTypes'

export default function NodeQuickEditorRegistrySchemaMappingsEditor({
  mappings,
  onChange,
}: {
  mappings: NodeQuickEditorRegistrySchemaMapping[]
  onChange: (next: NodeQuickEditorRegistrySchemaMapping[]) => void
}) {
