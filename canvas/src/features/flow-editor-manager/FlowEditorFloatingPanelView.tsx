      ...
      <section className="flex min-h-0 flex-1 flex-col" data-kg-flow-editor-port-split="1">
        ...
        >
          ...
          <VideoAgentValidationImportControls
            ...
            containerAriaLabel="Flow Editor video-agent validation import controls"
            docPathAriaLabel="Flow Editor video-agent validation document path"
            urlsAriaLabel="Flow Editor video-agent validation import URLs"
            actionsAriaLabel="Flow Editor video-agent validation URL actions"
