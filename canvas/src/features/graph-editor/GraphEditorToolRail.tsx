  ...
  return (
    ...
    >
        ...
        {TOOLS.map(t => {
          ...
          return (
            <button
              key={t.id}
              type="button"
              className={`flex items-center gap-2 rounded-lg px-2 py-2 text-xs transition ${isActive ? `${UI_THEME_TOKENS.button.activeBg} ${UI_THEME_TOKENS.button.activeText}` : `${UI_THEME_TOKENS.button.text} ${UI_THEME_TOKENS.button.hoverBg}`}`}
            ...
            >
              ...
              <span className={`rounded px-1.5 py-0.5 ${UI_THEME_TOKENS.badge.chip} ${UI_THEME_TOKENS.badge.text} ${UI_THEME_TOKENS.text.tertiary}`}>{t.hotkey}</span>
            </button>
          )
        })}
      </div>
      ...
      <div className="flex flex-col p-1">
        <button
          type="button"
          className={`flex items-center gap-2 rounded-lg px-2 py-2 text-xs transition ${UI_THEME_TOKENS.button.text} ${UI_THEME_TOKENS.button.hoverBg}`}
          onClick={() => {
        ...
        >
          ...
          <span className="flex-1 text-left">Export JSON</span>
        </button>
      </div>
    </nav>
  )
