...
const BYTEPLUS_CODEBASE_LOCATION_BY_VALUE_KEY: Readonly<Record<string, CodebaseLocation>> = {
  chatProvider: { modules: ['canvas/src/lib/chatEndpoint.ts', 'canvas/src/hooks/store/uiSlice.ts', 'canvas/src/features/storyboard-widget-manager/registryTemplates.ts'], classes: ['GraphState', 'WidgetRegistryEntry'], functions: ['normalizeChatProviderId', 'setChatProvider', 'inferTextGenerationProviderFamily'] },
  ...
  chatEndpointUrl: { modules: ['canvas/src/lib/chatEndpoint.ts', 'canvas/src/hooks/store/uiSlice.ts', 'canvas/src/features/storyboard-widget-manager/registryTemplates.ts'], classes: ['GraphState', 'RunGenerationConfig'], functions: ['normalizeChatEndpointUrlInput', 'resolveChatEndpointForRequest', 'setChatEndpointUrl'] },
