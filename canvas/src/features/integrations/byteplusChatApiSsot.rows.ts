...
const BYTEPLUS_CODEBASE_LOCATION_BY_VALUE_KEY: Readonly<Record<string, CodebaseLocation>> = {
  chatProvider: { modules: ['canvas/src/lib/chatEndpoint.ts', 'canvas/src/hooks/store/uiSlice.ts', 'canvas/src/features/flow-editor-manager/registryTemplates.ts'], classes: ['GraphState', 'WidgetRegistryEntry'], functions: ['normalizeChatProviderId', 'setChatProvider', 'inferTextGenerationProviderFamily'] },
  chatAuthMode: { modules: ['canvas/src/hooks/store/uiSlice.ts', 'canvas/src/features/settings/registry-ui.ui.ts', 'canvas/src/components/FlowEditorCanvas.tsx'], classes: ['GraphState', 'RunGenerationConfig'], functions: ['setChatAuthMode', 'setChatApiKey', 'generateRunMarkdownWithProvider'] },
  chatEndpointUrl: { modules: ['canvas/src/lib/chatEndpoint.ts', 'canvas/src/hooks/store/uiSlice.ts', 'canvas/src/features/flow-editor-manager/registryTemplates.ts'], classes: ['GraphState', 'RunGenerationConfig'], functions: ['normalizeChatEndpointUrlInput', 'resolveChatEndpointForRequest', 'setChatEndpointUrl'] },
  chatApiKey: { modules: ['canvas/src/hooks/store/uiSlice.ts', 'canvas/src/features/settings/registry-ui.ui.ts', 'canvas/src/components/FlowEditorCanvas.tsx'], classes: ['GraphState', 'RunGenerationConfig'], functions: ['setChatApiKey', 'setChatAuthMode', 'generateRunMarkdownWithProvider'] },
  chatModel: { modules: ['canvas/src/lib/chatEndpoint.ts', 'canvas/src/hooks/store/uiSlice.ts', 'canvas/src/features/flow-editor-manager/registryTemplates.ts'], classes: ['GraphState', 'WidgetRegistryEntry'], functions: ['getDefaultChatModelForProvider', 'normalizeChatModelIdForProvider', 'setChatModel'] },
  chatMessagesJson: { modules: ['canvas/src/features/flow-editor-manager/registryTemplates.ts', 'canvas/src/components/FlowEditorCanvas.tsx', 'canvas/src/features/chat/byteplusRunGeneration.ts'], classes: ['WidgetRegistryEntry', 'RunTextGenerationOptions'], functions: ['buildBytePlusTextGenerationFields', 'resolveEffectiveTextGenerationWidgetProperties', 'generateRunMarkdownWithProvider'] },
  chatThinkingJson: { modules: ['canvas/src/features/settings/registry-ui.ui.ts', 'canvas/src/features/chat/FloatingPanelChat.helpers.ts', 'canvas/src/features/chat/byteplusRunGeneration.ts'], classes: ['GraphState', 'RunTextGenerationOptions'], functions: ['setChatThinkingJson', 'buildProviderChatRequestOptions', 'generateRunMarkdownWithProvider'] },
  chatThinkingType: { modules: ['canvas/src/features/settings/registry-ui.ui.ts', 'canvas/src/features/chat/FloatingPanelChat.helpers.ts', 'canvas/src/features/chat/byteplusRunGeneration.ts'], classes: ['GraphState', 'RunTextGenerationOptions'], functions: ['setChatThinkingType', 'buildProviderChatRequestOptions', 'generateRunMarkdownWithProvider'] },
  chatStream: { modules: ['canvas/src/features/settings/registry-ui.ui.ts', 'canvas/src/features/chat/FloatingPanelChat.helpers.ts', 'canvas/src/features/chat/byteplusRunGeneration.ts'], classes: ['GraphState', 'RunTextGenerationOptions'], functions: ['setChatStream', 'buildProviderChatRequestOptions', 'generateRunMarkdownWithProvider'] },
  chatStreamOptionsJson: { modules: ['canvas/src/features/settings/registry-ui.ui.ts', 'canvas/src/features/chat/FloatingPanelChat.helpers.ts', 'canvas/src/features/chat/byteplusRunGeneration.ts'], classes: ['GraphState', 'RunTextGenerationOptions'], functions: ['setChatStreamOptionsJson', 'buildProviderChatRequestOptions', 'generateRunMarkdownWithProvider'] },
  chatMaxCompletionTokens: { modules: ['canvas/src/features/settings/registry-ui.ui.ts', 'canvas/src/hooks/store/uiSlice.ts', 'canvas/src/features/chat/FloatingPanelChat.helpers.ts'], classes: ['GraphState', 'RunTextGenerationOptions'], functions: ['setChatMaxCompletionTokens', 'buildProviderChatRequestOptions', 'generateRunMarkdownWithProvider'] },
  chatServiceTier: { modules: ['canvas/src/features/settings/registry-ui.ui.ts', 'canvas/src/hooks/store/uiSlice.ts', 'canvas/src/features/chat/FloatingPanelChat.helpers.ts'], classes: ['GraphState', 'RunTextGenerationOptions'], functions: ['setChatServiceTier', 'buildProviderChatRequestOptions', 'generateRunMarkdownWithProvider'] },
  chatStopJson: { modules: ['canvas/src/features/settings/registry-ui.ui.ts', 'canvas/src/features/chat/FloatingPanelChat.helpers.ts', 'canvas/src/features/chat/byteplusRunGeneration.ts'], classes: ['GraphState', 'RunTextGenerationOptions'], functions: ['setChatStopJson', 'buildProviderChatRequestOptions', 'generateRunMarkdownWithProvider'] },
  chatReasoningEffort: { modules: ['canvas/src/features/settings/registry-ui.ui.ts', 'canvas/src/features/chat/FloatingPanelChat.helpers.ts', 'canvas/src/features/chat/byteplusRunGeneration.ts'], classes: ['GraphState', 'RunTextGenerationOptions'], functions: ['setChatReasoningEffort', 'buildProviderChatRequestOptions', 'generateRunMarkdownWithProvider'] },
  chatResponseFormatJson: { modules: ['canvas/src/features/settings/registry-ui.ui.ts', 'canvas/src/features/chat/FloatingPanelChat.helpers.ts', 'canvas/src/features/chat/byteplusRunGeneration.ts'], classes: ['GraphState', 'RunTextGenerationOptions'], functions: ['setChatResponseFormatJson', 'buildProviderChatRequestOptions', 'generateRunMarkdownWithProvider'] },
  chatFrequencyPenalty: { modules: ['canvas/src/features/settings/registry-ui.ui.ts', 'canvas/src/features/chat/FloatingPanelChat.helpers.ts', 'canvas/src/features/chat/byteplusRunGeneration.ts'], classes: ['GraphState', 'RunTextGenerationOptions'], functions: ['setChatFrequencyPenalty', 'buildProviderChatRequestOptions', 'generateRunMarkdownWithProvider'] },
  chatPresencePenalty: { modules: ['canvas/src/features/settings/registry-ui.ui.ts', 'canvas/src/features/chat/FloatingPanelChat.helpers.ts', 'canvas/src/features/chat/byteplusRunGeneration.ts'], classes: ['GraphState', 'RunTextGenerationOptions'], functions: ['setChatPresencePenalty', 'buildProviderChatRequestOptions', 'generateRunMarkdownWithProvider'] },
  chatTemperature: { modules: ['canvas/src/features/settings/registry-ui.ui.ts', 'canvas/src/features/chat/FloatingPanelChat.helpers.ts', 'canvas/src/features/chat/byteplusRunGeneration.ts'], classes: ['GraphState', 'RunTextGenerationOptions'], functions: ['setChatTemperature', 'buildProviderChatRequestOptions', 'generateRunMarkdownWithProvider'] },
  chatTopP: { modules: ['canvas/src/features/settings/registry-ui.ui.ts', 'canvas/src/features/chat/FloatingPanelChat.helpers.ts', 'canvas/src/features/chat/byteplusRunGeneration.ts'], classes: ['GraphState', 'RunTextGenerationOptions'], functions: ['setChatTopP', 'buildProviderChatRequestOptions', 'generateRunMarkdownWithProvider'] },
  chatLogprobs: { modules: ['canvas/src/features/settings/registry-ui.ui.ts', 'canvas/src/features/chat/FloatingPanelChat.helpers.ts', 'canvas/src/features/chat/byteplusRunGeneration.ts'], classes: ['GraphState', 'RunTextGenerationOptions'], functions: ['setChatLogprobs', 'buildProviderChatRequestOptions', 'generateRunMarkdownWithProvider'] },
  chatTopLogprobs: { modules: ['canvas/src/features/settings/registry-ui.ui.ts', 'canvas/src/features/chat/FloatingPanelChat.helpers.ts', 'canvas/src/features/chat/byteplusRunGeneration.ts'], classes: ['GraphState', 'RunTextGenerationOptions'], functions: ['setChatTopLogprobs', 'buildProviderChatRequestOptions', 'generateRunMarkdownWithProvider'] },
  chatLogitBiasJson: { modules: ['canvas/src/features/settings/registry-ui.ui.ts', 'canvas/src/features/chat/FloatingPanelChat.helpers.ts', 'canvas/src/features/chat/byteplusRunGeneration.ts'], classes: ['GraphState', 'RunTextGenerationOptions'], functions: ['setChatLogitBiasJson', 'buildProviderChatRequestOptions', 'generateRunMarkdownWithProvider'] },
  chatToolsJson: { modules: ['canvas/src/features/settings/registry-ui.ui.ts', 'canvas/src/features/chat/FloatingPanelChat.helpers.ts', 'canvas/src/features/chat/byteplusRunGeneration.ts'], classes: ['GraphState', 'RunTextGenerationOptions'], functions: ['setChatToolsJson', 'buildProviderChatRequestOptions', 'generateRunMarkdownWithProvider'] },
  chatParallelToolCalls: { modules: ['canvas/src/features/settings/registry-ui.ui.ts', 'canvas/src/features/chat/FloatingPanelChat.helpers.ts', 'canvas/src/features/chat/byteplusRunGeneration.ts'], classes: ['GraphState', 'RunTextGenerationOptions'], functions: ['setChatParallelToolCalls', 'buildProviderChatRequestOptions', 'generateRunMarkdownWithProvider'] },
  chatToolChoiceJson: { modules: ['canvas/src/features/settings/registry-ui.ui.ts', 'canvas/src/features/chat/FloatingPanelChat.helpers.ts', 'canvas/src/features/chat/byteplusRunGeneration.ts'], classes: ['GraphState', 'RunTextGenerationOptions'], functions: ['setChatToolChoiceJson', 'buildProviderChatRequestOptions', 'generateRunMarkdownWithProvider'] },
}
