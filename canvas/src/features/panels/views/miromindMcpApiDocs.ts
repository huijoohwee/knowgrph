...
const MIROMIND_MCP_DOC_ROWS: ReadonlyArray<MiroMindMcpDocRow> = [
  ...
  },
  {
    key: 'transport',
    typeLabel: 'string',
    value: 'Provider-side remote MCP descriptors passed per request.',
  ...
  },
  {
    key: 'availability',
    typeLabel: 'string',
    value: 'Optional and plan-dependent; private-beta assumptions must not block baseline MiroMind chat completions.',
  ...
  },
  {
    key: 'boundary',
    typeLabel: 'readiness',
    value: 'Knowgrph MCP readiness remains owned by MainPanel MCP and browser/local MCP surfaces. MiroMind mcp_servers never replaces the shared FloatingPanel Chat -> markdown YAML frontmatter -> workspace -> canvas path.',
