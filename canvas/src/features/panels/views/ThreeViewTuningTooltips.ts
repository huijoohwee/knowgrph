...
export const POLYGON_ELEVATION_TOOLTIP = buildNumericTooltip({
  ...
  max: 5,
  interval: 0.1,
  impact: 'Negative values sink polygons slightly under nodes; positive values lift them above.',
})
...
export const POLYGON_OPACITY_MULTIPLIER_TOOLTIP = buildNumericTooltip({
  ...
  max: 2,
  interval: 0.05,
  impact: 'Higher values make 3D group surfaces denser; lower values keep them faint and subtle.',
})
