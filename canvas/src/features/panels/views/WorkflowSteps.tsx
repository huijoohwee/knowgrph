    ...
    <div className="mt-3">
      ...
      >
        ...
        <div className={`${uiPanelKeyValueTextSizeClass} ${uiPanelTextFontClass} text-gray-500 mt-1`}>
          After loading the graph, use the toolbar Radial Layout and Group Polygons toggles to orbit nodes in 2D and outline related phases, datasets, and artifacts using schema.metadata["canvas:polygons"].
        </div>
      </CollapsibleSection>
