...
export const FLOATING_BUBBLE_TOOLBAR_CLASSNAME = ['absolute rounded border shadow-sm z-20 m-0 p-1 text-[10px]', UI_THEME_TOKENS.panel.bg, UI_THEME_TOKENS.panel.border].join(' ')
