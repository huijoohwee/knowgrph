...
import { UI_RESPONSIVE_INLINE_ELEMENT_ROW_CLASSNAME, UI_RESPONSIVE_MENU_ROW_CLASSNAME } from '@/lib/ui/responsiveElementClasses'
...
export const FLOATING_MENU_RIGHT_W220_CLASSNAME = [FLOATING_MENU_CLASSNAME, 'kg-data-view-floating-menu right-0 w-[220px]'].join(' ')
export const FLOATING_MENU_LEFT_W220_CLASSNAME = [FLOATING_MENU_CLASSNAME, 'kg-data-view-floating-menu left-0 w-[220px]'].join(' ')
...
export const FLOATING_BUBBLE_TOOLBAR_CLASSNAME = ['absolute rounded border shadow-sm z-20 m-0 p-1', uiToolbarRowScrollClassName, 'gap-1 text-[10px]', UI_THEME_TOKENS.panel.bg, UI_THEME_TOKENS.panel.border].join(' ')
export const FLOATING_BUBBLE_BUTTON_CLASSNAME = ['kg-toolbar-btn rounded cursor-pointer', UI_RESPONSIVE_INLINE_ELEMENT_ROW_CLASSNAME, 'justify-center', UI_THEME_TOKENS.button.square, UI_THEME_TOKENS.button.text, UI_THEME_TOKENS.button.hoverBg].join(' ')
export const FLOATING_POPOVER_PANEL_CLASSNAME = ['kg-data-view-floating-menu absolute rounded border shadow-sm z-20 m-0 p-2 w-[280px]', UI_THEME_TOKENS.panel.bg, UI_THEME_TOKENS.panel.border].join(' ')
