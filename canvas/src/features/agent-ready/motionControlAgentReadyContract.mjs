...
export function buildMotionControlAgentReadyToolContracts({ buildWebName, readOnlyAnnotations, mutationAnnotations }) {
  return [{
    ...
    description: 'Inspect browser-local camera, official LiteRT pose model, accelerator, confidence, latency, selected XR humanoid, existing scene/animation target owners, privacy, and native /motion.control @canvas #pose grammar without exposing frames.',
    inputSchema: { type: 'object', additionalProperties: false, properties: {} },
    outputSchema: {
      type: 'object',
      additionalProperties: true,
      required: ['schema', 'webMcpTools', 'invocationGrammar', 'model', 'runtime', 'privacy', 'targets'],
      properties: { targets: buildMotionControlTargetsOutputSchema(buildWebName) },
    },
