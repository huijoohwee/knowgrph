...
export async function testFlowEditorUnpinnedQuickEditorDoesNotSnapToPhantomBorderOnLayoutChange() {
  ...
  try {
    ...
    const viewportW = 800
    const dockedLeft = viewportW - NODE_QUICK_EDITOR_BASE_SIZE.width - 16
    api.setFlowNodeQuickEditorPosByNodeId({ n1: { top: 96, left: dockedLeft } })
