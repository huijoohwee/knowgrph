import { buildGenerateVideoRegistryDraft, buildWidgetDraftFromSmartFields } from '@/features/flow-editor-manager/registryTemplates'
...
export function testFlowEditorManagerBuildVideoDraftFromSmartFieldsUsesVideoGenerationFormId() {
