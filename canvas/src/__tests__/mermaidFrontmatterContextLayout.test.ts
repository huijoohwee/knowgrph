...
export function testMermaidFrontmatterContextLayoutPositionsAnchorsAndBlocks() {
  const nodes: GraphNode[] = [
    ...
    },
    {
      ...
      metadata: { lineStart: 10, lineEnd: 10, documentPath: 'fixtures/mddemo.md' },
    },
    {
      id: 's1',
      label: 'Phase 1 Input',
      ...
      metadata: { lineStart: 11, lineEnd: 12, documentPath: 'fixtures/mddemo.md' },
    },
    {
      id: 'p1',
      label: 'Paragraph 1',
      ...
      metadata: { lineStart: 13, lineEnd: 14, documentPath: 'fixtures/mddemo.md' },
    },
    {
      id: 'il1',
      ...
      metadata: { lineStart: 13, lineEnd: 13, documentPath: 'fixtures/mddemo.md' },
    },
    {
      id: 'a2',
      label: 'phase-2-transform',
      ...
      metadata: { lineStart: 20, lineEnd: 20, documentPath: 'fixtures/mddemo.md' },
    },
  ]
