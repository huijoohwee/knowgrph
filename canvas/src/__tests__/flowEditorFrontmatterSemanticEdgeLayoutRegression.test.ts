...
} from '@/lib/flowEditor/frontmatterCollectiveLayout'
...
export function testFlowEditorOverlayRuntimeHasNoDemoSpecificShotEdgeIds() {
  const root = process.cwd()
  const runtimeFiles = [
    path.resolve(root, 'src', 'components', 'FlowEditorCanvas', 'runtime', 'flowEditorRenderGraph.ts'),
    path.resolve(root, 'src', 'components', 'FlowEditorCanvas', 'runtime', 'useFlowEditorOverlayEdges.ts'),
  ]
