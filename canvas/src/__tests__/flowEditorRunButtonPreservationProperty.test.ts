/**
 * Preservation Property Tests — Flow Editor Run Button Regression (Property-Based)
 *
...
// ---------------------------------------------------------------------------
// Node data (from knowgrph-flow-editor-computing-flow-template.md)
 ...
 * **Validates: Requirements 3.1**
 */
export function testFlowEditorRunButtonPreservation_EditButton_OpensFieldEditor() {
  ...
  const text = readFileSync(
    resolve(process.cwd(), 'src/components/FlowEditorCanvas/runtime/flowEditorOverlaySurfaceElements.tsx'),
    'utf8',
  )
  if (!text.includes('runWorkflowNode')) throw new Error('handler path missing: flowEditorOverlaySurfaceElements.tsx does not reference runWorkflowNode')
}
 ...
 * **Validates: Requirements 3.2**
 */
export function testFlowEditorRunButtonPreservation_ResetButton_ClearsOutputs() {
 ...
 * **Validates: Requirements 3.4**
 */
export function testFlowEditorRunButtonPreservation_SideEffects_RunStatusAndMutated() {
 ...
 * **Validates: Requirements 3.5**
 */
export function testFlowEditorRunButtonPreservation_ButtonRendering_LabelsIconsPrimary() {
