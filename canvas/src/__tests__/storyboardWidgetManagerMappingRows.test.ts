import {
  ...
  validateMappingRows,
} from '@/features/storyboard-widget-manager/mappingRows'

import type { WidgetRegistryEntry } from '@/features/storyboard-widget-manager/widgetRegistryTypes'

export function testStoryboardWidgetManagerMappingRowsRoundTripPreservesLabels() {
...
export function testStoryboardWidgetManagerMappingRowsValidationDetectsDuplicates() {
