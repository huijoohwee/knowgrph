...
export function testStoryboardWidgetManagerResolvesWidgetRegistryApiDocRefs() {
...
export function testStoryboardWidgetManagerResolvesWidgetRegistryMainPanelLinks() {
