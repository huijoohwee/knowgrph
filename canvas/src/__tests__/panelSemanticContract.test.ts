...
export const testFloatingPanelRemovesDesignLayersViewAfterWorkflowManagerConsolidation = () => {
  ...
  if (
    ...
    || !commandCatalogPanelText.includes('group relative inline-flex h-[4.625rem] w-[6.475rem]')
  ...
  if (
    ...
    || !mediaLightboxText.includes('ZoomPanViewport')
    ...
    || !mediaLightboxText.includes('LS_KEYS.previewZoomPanMedia')
