...
export function testCanvasViewRendererOptionsStaySelectableAcrossInactiveVoxelState() {
  ...
  const requiredSelectable: CanvasViewOptionId[] = ['renderer:flowchart', 'renderer:flow', 'renderer:animatic', 'renderer:storyboard', 'renderer:flowEditor', 'renderer:d3', 'renderer:dashboard', 'renderer:gallery', 'renderer:design']
