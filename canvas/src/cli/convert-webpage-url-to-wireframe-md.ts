...
import { runWebpageConvert, buildWireframeMarkdown, clampInt } from '@/lib/websites/server/websiteImportCore'
...
function parseArgs(argv: string[]): Args {
  ...
  return { url, out, detail, includeImages, pythonBin }
}
...
async function main() {
  ...
  const outDoc = upsertWebpageFrontmatterMeta(docParts.join('\n') + '\n', { url: args.url, view: 'wireframe' })
