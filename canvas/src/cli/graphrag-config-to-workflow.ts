...
import { DEFAULT_GRAPHRAG_CONFIG_PATH, parseGraphragCliConfigYamlToJsonLd } from '@/features/panels/utils/graphragConfig'

const argv = process.argv.slice(2)
const configArg = argv[0]
const graphIdArg = argv[1]

const configPath = configArg && configArg.trim() ? configArg.trim() : DEFAULT_GRAPHRAG_CONFIG_PATH
