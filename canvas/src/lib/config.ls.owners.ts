...
export const LS_KEY_OWNERS: Partial<Record<LsKeyId, LsKeyOwner>> = {
  ...
  workspaceImportDefaultSourceUrl: 'ui.workspace',
  workspaceImportVideoDownloadOutputDir: 'ui.workspace',
  workspaceImportShareExportRootPath: 'ui.workspace',
  ...
  storyboardWidgetManagerWidgetRegistry: 'ui.mainPanel',
  storyboardWidgetManagerNodeSpec: 'ui.mainPanel',
  storyboardWidgetManagerWorkflowSpec: 'ui.mainPanel',
  ...
  storyboardWidgetSelectionOnDrag: 'ui.workspace',
  storyboardWidgetOverlayWheelProxyEnabled: 'ui.workspace',
