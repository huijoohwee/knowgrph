  ...
  return [
    {
      ...
      required: true,
      label: 'Model',
      options: toFieldOptions(STORYBOARD_WIDGET_IMAGE_MODEL_OPTIONS),
    },
    {
      fieldKey: 'prompt',
      fieldType: 'textarea',
    ...
    },
    {
      ...
      required: true,
      label: 'Size',
      options: toFieldOptions(STORYBOARD_WIDGET_IMAGE_SIZE_OPTIONS),
    },
    {
      ...
      required: true,
      label: 'Output format',
      options: toFieldOptions(STORYBOARD_WIDGET_IMAGE_OUTPUT_FORMAT_OPTIONS),
    },
    {
