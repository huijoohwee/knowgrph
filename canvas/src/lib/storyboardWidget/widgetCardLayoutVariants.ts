    ...
    return {
      ...
      properties: {
        ...
        prompt: [
          ...
          'Generate a reusable Markdown slide deck and a Markdown financial-model spreadsheet.',
          'Keep assumptions explicit and do not invent source facts.',
        ].join('\n'),
        summary: 'Connect a Rich Media output to prompt_in, then Run to publish two reusable Markdown panels.',
        output: '',
