import { isNodeOwnedFrontmatterWidgetRegistryEntry } from '@/features/storyboard-widget-manager/resolveWidgetRegistry'
import { FLOW_RICH_MEDIA_PANEL_NODE_TYPE_ID, readWidgetRegistryMetadataEntries } from '@/lib/config.storyboard-widget'
