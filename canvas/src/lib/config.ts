...
export const WORKSPACE_IMPORT_AUTO_PARSE_MAX_FILES = 100
...
export const WORKSPACE_IMPORT_DEFER_LOCAL_MODEL_BYTES = 128_000

export const WORKSPACE_IMPORT_DEFER_LOCAL_GLB_BYTES = WORKSPACE_IMPORT_DEFER_LOCAL_MODEL_BYTES

export const SOURCE_FILES_REPARSE_CONCURRENCY = 2
