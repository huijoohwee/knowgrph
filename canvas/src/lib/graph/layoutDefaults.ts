...
import * as ZoomPresets from 'grph-shared/zoom/presets'

export const DEFAULT_FIT_PADDING = ZoomPresets.DEFAULT_FIT_PADDING
export const DEFAULT_FIT_TO_SCREEN_FILL_RATIO = ZoomPresets.DEFAULT_FIT_TO_SCREEN_FILL_RATIO
export const DEFAULT_ZOOM_MIN_SCALE = ZoomPresets.DEFAULT_ZOOM_MIN_SCALE
export const DEFAULT_ZOOM_MIN_SCALE_HARD_CAP =
  typeof (ZoomPresets as unknown as { DEFAULT_ZOOM_MIN_SCALE_HARD_CAP?: unknown }).DEFAULT_ZOOM_MIN_SCALE_HARD_CAP === 'number'
    ? (ZoomPresets as unknown as { DEFAULT_ZOOM_MIN_SCALE_HARD_CAP: number }).DEFAULT_ZOOM_MIN_SCALE_HARD_CAP
    : 0.000001
export const DEFAULT_ZOOM_MAX_SCALE = ZoomPresets.DEFAULT_ZOOM_MAX_SCALE
export const DEFAULT_ZOOM_MAX_SCALE_HARD_CAP = 1_000_000
export const DEFAULT_LINK_DISTANCE = 350
export const DEFAULT_CHARGE = -1200
export const DEFAULT_CENTER_STRENGTH = 0.08
export const DEFAULT_ALPHA_DECAY = 0.02

export const DEFAULT_DRAG_ALPHA_TARGET = 0.12
export const DEFAULT_DRAG_ALPHA_TARGET_HARD_CAP = 0.22
export const DEFAULT_DRAG_CHARGE_SCALE = 0.5
export const DEFAULT_DRAG_CHARGE_MAG_MIN = 18
export const DEFAULT_DRAG_CHARGE_MAG_MAX = 220
export const DEFAULT_DRAG_DISTANCE_MAX = 900

export const DEFAULT_DISJOINT_MIN_BASE_STRENGTH = 0.05
export const DEFAULT_DISJOINT_STRENGTH = 0.1
export const DEFAULT_DISJOINT_ANCHOR_STRENGTH_SCALE = 0.15
export const DEFAULT_CENTER_ANCHOR_STRENGTH_SCALE = 0.15

export const DEFAULT_BBOX_COLLIDE_PADDING = 80
export const DEFAULT_BBOX_COLLIDE_STRENGTH = 1.0
export const DEFAULT_BBOX_COLLIDE_ITERATIONS = 4
...
export const DEFAULT_COMPONENT_BBOX_COLLIDE_PADDING = Math.max(24, Math.floor(DEFAULT_BBOX_COLLIDE_PADDING * 0.5))
export const DEFAULT_COMPONENT_BBOX_COLLIDE_STRENGTH = Math.max(0.18, DEFAULT_BBOX_COLLIDE_STRENGTH * 0.28)
export const DEFAULT_COMPONENT_BBOX_COLLIDE_ITERATIONS = 2
...
export const DEFAULT_NODE_COLLISION_TOUCH_EPSILON_PX = 2
export const DEFAULT_GROUP_COLLISION_BORDER_GAP_PX = 12
export const DEFAULT_GROUP_COLLISION_TOUCH_EPSILON_PX = 4
