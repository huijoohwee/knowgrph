...
export const UI_COPY = {
  ...
  flowWidgetRichMediaKtvRows: 'Switch to Rich Media Panel KTV Rows; the outer surface keeps the centered port pair.',
  ...
  chatPromptPresetSelectLabel: 'Prompt preset',
  chatPromptPresetSelectTitle: 'Select a centralized Agentic Canvas OS prompt preset',
  chatPromptPresetUnavailableLabel: 'Preset unavailable',
  chatPromptPresetUnavailableError: 'Prompt preset catalog is unavailable.',
  chatLoadPresetButtonLabel: 'Load preset',
  chatLoadingPresetButtonLabel: 'Loading…',
  chatLoadPresetButtonTitle: 'Load the selected centralized prompt preset',
