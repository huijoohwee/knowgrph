import { createGraphFieldsUiCopy } from '@/lib/config-copy/graphFieldsUiCopy'
...
export const UI_COPY = {
  ...
  floatingPanelPrefix: 'Floating panel:',
  bottomSurfacePrefix: 'Bottom surface:',
  ...
  flowWidgetHelp: 'Help',
  flowWidgetRemoveNode: 'Remove selected node',
  flowWidgetMenu: 'More node actions',
  flowWidgetOpenInSidepane: 'Open selected node in sidepane',
  flowWidgetRun: 'Run',
  flowWidgetEnableHandles: 'Enable handles for all inputs',
  flowWidgetConvertToLoop: 'Convert to loop node',
  flowWidgetHelpToast: 'Widget: both modes follow canvas zoom/pan. Pin disables drag; unpin enables drag. Escape closes the menu.',
  flowWidgetEnableHandlesToast: 'Port Handles enabled for all nodes.',
  flowWidgetEnableHandlesAlreadyOnToast: 'Port Handles are already enabled for all inputs.',
  flowWidgetEnableHandlesBaselineLockedToast: BASELINE_LOCKED_TOAST,
  flowWidgetConvertToLoopToast: 'Converted node to Loop.',
  flowWidgetConvertToLoopAlreadyLoopToast: 'Node is already a Loop.',
  ...
  propsPanelOpenSourceInFloatingPanel: 'Open Source in Floating Panel',
  propsPanelOpenTargetInFloatingPanel: 'Open Target in Floating Panel',
  ...
  canvasViewRendererStrybldrTitle: CANVAS_VIEW_RENDERER_STRYBLDR_TITLE,
  ...
  markdownDataViewSearchPlaceholder: 'Search...',
  markdownDataViewNewRecordLabel: 'New Record',
  ...
  ...createGraphFieldsUiCopy({
    clipboardNotAvailable: CLIPBOARD_NOT_AVAILABLE,
  ...
  storageSyncOnLabel: 'On',
  storageSyncOffLabel: 'Off',
  storageSyncOnTooltip: 'Storage sync: Source Files and the configured docs mirror refresh are active.',
  storageSyncOffTooltip: 'Storage sync: Source Files docs mirror refresh is paused.',
  ...
  markdownWorkspaceViewingGraphJsonLabel: 'Viewing graph JSON',
  ...
  markdownWorkspaceExternalPreviewMissingCodebasePathLabel:
    'External File Preview: selected row has no metadata.codebasePath (nothing to load).',
  markdownWorkspaceLoadingLabel: 'Loading markdown…',
  markdownWorkspaceLoadFailedLabel: 'Failed to load markdown.',
  markdownWorkspaceNoMarkdownLabel: 'No imported markdown available.',
  markdownWorkspaceMissingPathError: MISSING_PATH,
  markdownWorkspaceLoadFailedError: FAILED_TO_LOAD_MARKDOWN,
  ...
  markdownWorkspaceEditorTitle: 'Markdown Editor',
  markdownWorkspaceViewerTitle: 'Markdown Viewer',
  markdownWorkspaceWordWrapToggleTitle: 'Toggle word wrap',
  markdownWorkspaceWordWrapOnTooltip: 'Word wrap: On',
  markdownWorkspaceWordWrapOffTooltip: 'Word wrap: Off',
  markdownWorkspaceFullEditorViewToggleTitle: 'Toggle full editor view',
  markdownWorkspaceFullEditorViewOnTooltip: 'Full editor view: On',
  markdownWorkspaceFullEditorViewOffTooltip: 'Full editor view: Off',
  markdownWorkspaceFullViewerViewToggleTitle: 'Toggle full viewer view',
  markdownWorkspaceFullViewerViewOnTooltip: 'Full viewer view: On',
  markdownWorkspaceFullViewerViewOffTooltip: 'Full viewer view: Off',
  markdownWorkspaceSyncScrollToggleTitle: 'Toggle synchronize scrolling',
  markdownWorkspaceSyncScrollOnTooltip: 'Synchronize scrolling: On',
  markdownWorkspaceSyncScrollOffTooltip: 'Synchronize scrolling: Off',
  markdownWorkspaceSplitViewToggleTitle: 'Switch to split view',
  markdownWorkspaceSplitViewOnTooltip: 'Split view: On',
  markdownWorkspaceSplitViewOffTooltip: 'Split view: Off',
  markdownWorkspaceTextHighlightToggleTitle: 'Toggle text highlight',
  markdownWorkspaceTextHighlightOnTooltip: 'Text highlight: On',
  markdownWorkspaceTextHighlightOffTooltip: 'Text highlight: Off',
  markdownWorkspacePresentationModeToggleTitle: 'Toggle presentation mode',
  markdownWorkspacePresentationModeOnTooltip: 'Presentation mode: On',
  markdownWorkspacePresentationModeOffTooltip: 'Presentation mode: Off',
  markdownWorkspaceFullscreenToggleTitle: 'Enter Full Screen',
  markdownWorkspaceFullscreenOnTooltip: 'Exit Full Screen',
  markdownWorkspaceFullscreenOffTooltip: 'Enter Full Screen',
  markdownWorkspaceEditToggleTitle: 'Toggle Markdown view/editor',
  markdownWorkspaceApplyButtonLabel: 'Apply changes',
  markdownWorkspaceApplyButtonTitle: 'Apply changes (Cmd/Ctrl+Enter toggles Editor/Viewer)',
  markdownWorkspaceStatusLoading: 'Loading',
  markdownWorkspaceStatusReady: 'Ready',
  markdownWorkspaceStatusError: 'Error',
  markdownWorkspaceApplyJsonBackedUnsupportedStatus:
  ...
  markdownWorkspaceJsonBackedPreviewBadgeLabel: 'JSON-backed preview',
  markdownWorkspaceJsonBackedPreviewBadgeTooltip:
    'Preview of the last JSON/JSON-LD import. Edit graph structure via UI Editor; Apply from Markdown is disabled.',
  markdownWorkspaceJsonMarkdownModeLabel: 'JSON → Markdown mode',
  markdownWorkspaceJsonMarkdownModeAutoLabel: 'Auto',
  markdownWorkspaceJsonMarkdownModeTableLabel: 'Table',
  ...
  markdownWorkspaceNoSelectionLabel: 'Imported markdown loaded.',
  markdownWorkspaceMissingDocumentPathLabel: 'Selected row has no metadata.documentPath.',
  bottomSurfaceImportHistoryJsonLdAgenticRagButtonLabel: 'Import History JSON-LD (AgenticRAG)',
