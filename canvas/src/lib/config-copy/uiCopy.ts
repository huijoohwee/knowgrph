...
export const UI_COPY = {
  ...
  geospatialModeTooltip:
    'Geospatial Mode: overlays a MapLibre basemap and dataset layers on top of the canvas.',
  geospatialPanelSubtitle: 'Configure basemap style, overlay opacity, and dataset layers.',
  geospatialOverlayEnabledLabel: 'Enable Geospatial Mode',
  geospatialDatasetDefaultLabel: 'Dataset layer',
  geospatialStyleUrlLabel: 'Basemap style URL',
  geospatialStyleUrlPlaceholder: 'https://example.invalid/style.json',
  geospatialStyleHintPrefix: 'Hint:',
  geospatialStyleHintOpenFreeMap: 'OpenFreeMap Liberty',
  geospatialOverlayOpacityLabel: 'Overlay opacity',
  geospatialInteractionTitle: 'Interaction',
  geospatialInteractionModeLabel: 'Mode',
  geospatialInteractionModeOff: 'Off (graph only)',
  geospatialInteractionModeHoldSpace: 'Hold Space (temporary pan/zoom)',
  geospatialInteractionModeAlways: 'Always (map captures pointer)',
  geospatialProjectionTitle: 'Projection',
  geospatialProjectionModeLabel: 'Mode',
  geospatialProjectionModeAuto: 'Auto (follow 2D/3D mode)',
  geospatialProjectionModeMercator: 'Mercator (2D map)',
  geospatialProjectionModeGlobe: 'Globe (3D)',
  geospatialAnimationsTitle: 'Animations',
  geospatialAnimateCameraLabel: 'Animate camera moves',
  geospatialAutoFitEnabledLabel: 'Auto-fit to geo bounds (3D)',
  geospatialBasemapLoadingLabel: 'Loading basemap…',
  geospatialBasemapLoadedLabel: 'Basemap loaded.',
  geospatialBasemapOpacityZeroWarning: 'Geospatial Mode is ON, but overlay opacity is 0%. Increase opacity to see the basemap.',
  geospatialDatasetsTitle: 'Datasets',
  geospatialFitToDataLabel: 'Fit to data',
  geospatialDatasetsEmpty: 'No dataset layers configured.',
  geospatialDatasetLabelPlaceholder: 'Layer label',
  geospatialDatasetUrlPlaceholder: 'Dataset URL (GeoJSON or records)',
  geospatialDatasetRemoveLabel: 'Remove',
  geospatialDatasetFormatAuto: 'Format: auto',
  geospatialDatasetFormatGeoJson: 'Format: GeoJSON',
  geospatialDatasetFormatRecords: 'Format: records',
  geospatialDatasetStatusIdle: 'Status: idle',
  ...
  bottomPanelMarkdownFullscreenToggleTitle: 'Slides Gallery',
  bottomPanelMarkdownFullscreenOnTooltip: 'Exit Slides Gallery',
  bottomPanelMarkdownFullscreenOffTooltip: 'Enter Slides Gallery',
