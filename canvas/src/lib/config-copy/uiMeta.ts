...
export const UI_LABELS = {
  ...
  flowEditorManager: 'Workflow Manager',
  ...
  flowWidgetSmartFieldsLegend: 'Smart fields',
  flowWidgetModel: 'Model',
  flowWidgetPrompt: 'Prompt',
  flowWidgetContentJson: 'Content (JSON)',
  flowWidgetAspectRatio: 'Aspect ratio',
  flowWidgetDuration: 'Duration',
  flowWidgetResolution: 'Resolution',
  flowWidgetGenerateAudio: 'Generate audio',
  flowWidgetFast: 'Fast',
  flowWidgetWatermark: 'Watermark',
  flowWidgetReferenceImage: 'Reference image',
  flowWidgetValidate: 'Validate',
  flowWidgetActions: 'Widget actions',

  flowWidgetParamsLegend: 'Params',
  flowWidgetParamsJsonLabel: 'Params (JSON)',

  flowWidgetSchemaLegend: 'Schema',
  flowWidgetSchemaFieldsLegend: 'Fields',
  flowWidgetSchemaColumnLabel: 'Column',
  flowWidgetSchemaTypeLabel: 'Type',
  flowWidgetSchemaActionsLabel: 'Actions',
  flowWidgetSchemaAddField: 'Add field',
  flowWidgetSchemaRemoveField: 'Remove field',
  flowWidgetKeyLabel: 'Key',
  flowWidgetTypeLabel: 'Type',
  flowWidgetValueLabel: 'Value',
