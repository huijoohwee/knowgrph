...
export const UI_LABELS = {
  ...
  storyboardWidgetManager: 'Workflow Manager',
  storyboardWidgetMapping: 'Storyboard Widget Mapping',
  storyboardWidgetSpecification: 'Storyboard Widget Specification',
  storyboardWidgetGraph: 'Storyboard Widget Graph',
  node: 'Node',
  workflow: 'Workflow',
  sidebar: 'Sidebar',
  ...
  status: 'Status',
  editor: 'Editor',
  workspaceMultiDimTable: 'Multi-dimensional Table',
  ...
  pinPanel: 'Pin to canvas',
  unpinPanel: 'Unpin from canvas',
