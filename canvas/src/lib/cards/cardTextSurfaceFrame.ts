export const CARD_TEXT_SURFACE_COLUMN_CLASS_NAME =
  'flex min-h-0 flex-col gap-1.5 overflow-hidden rounded border bg-[color:var(--kg-panel-bg)]/70 p-1.5'
...
export const CARD_TEXT_SURFACE_VIEW_CLASS_NAME =
  'm-0 min-h-full select-none whitespace-pre-wrap break-words'
