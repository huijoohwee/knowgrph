...
export const TEST_CASES_POST_PARSER_6: TestCaseTuple[] = [
  ...
  ["canvas.probeTree.outputLayout.mediaOwnedScroll","@/__tests__/storyboardProbeTreeOutputLayout.test","testProbeTreeOutputMarkdownKeepsScrollingInsideCanonicalPanel"],
