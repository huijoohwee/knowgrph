...
export const TEST_CASES_POST_PARSER_6: TestCaseTuple[] = [
  ...
  ["canvas.probeTree.noModel.projectsLiteralAuthoredChoices","@/__tests__/probeTreeStructuredResponseContract.test","testProbeTreeAuthoredChoicesProjectLiteralZeroModelCard"],
  ...
  ["canvas.probeTree.widgetRun.projectsLiteralAuthoredChoices","@/__tests__/probeTreeWidgetRunAuthoredChoices.test","testProbeTreeWidgetRunProjectsLiteralAuthoredChoicesWithoutProvider"],
