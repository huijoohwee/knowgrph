...
export const TEST_CASES_POST_PARSER_6: TestCaseTuple[] = [
  ...
  ["ui.floatingPanelChat.promptPreset.centralizedCatalog","@/__tests__/floatingPanelChatVideoPreset.test","testFloatingPanelChatPromptPresetCatalogLoadsCentralizedAgents"],
  ["ui.floatingPanelChat.promptPreset.invalidCatalogFailsClosed","@/__tests__/floatingPanelChatVideoPreset.test","testFloatingPanelChatPromptPresetCatalogFailsClosedOnDuplicateEntry"],
