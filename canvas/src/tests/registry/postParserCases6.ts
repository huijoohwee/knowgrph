...
export const TEST_CASES_POST_PARSER_6: TestCaseTuple[] = [
  ...
  ["ui.floatingPanelChat.composer.mediaProjectionGrammar","@/__tests__/floatingPanelChatComposerCommands.test","testFloatingPanelChatComposerMediaProjectionPreservesInvocationGrammar"],
