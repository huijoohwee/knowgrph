...
export const TEST_CASES_POST_PARSER_6: TestCaseTuple[] = [
  ...
  ["richMedia.textOutput.versionSelectorPublishesSelection","@/__tests__/richMediaPanelTextModeRegression.test.tsx","testRichMediaPanelTextOutputVersionSelectorPublishesSelection"],
