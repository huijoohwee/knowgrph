...
export const TEST_CASES_POST_PARSER_6: TestCaseTuple[] = [
  ...
  ["canvas.probeTree.response.rejectsSourceQueryRestatement","@/__tests__/probeTreeStructuredResponseContract.test","testProbeTreeRestatedSourceQueryIsRejected"],
  ...
  ["canvas.probeTree.widgetRun.usesActiveChatRoute","@/__tests__/probeTreeWidgetRunMcpContract.test","testProbeTreeWidgetRunUsesActiveChatRouteOverStaleCardProvider"],
