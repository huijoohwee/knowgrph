...
export const TEST_CASES_POST_PARSER_6: TestCaseTuple[] = [
  ...
  ["canvas.probeTree.inputDerived.projectsWithoutStructuredTextParsing","@/__tests__/probeTreeStructuredResponseContract.test","testProbeTreeInputDerivedCardsProjectWithoutStructuredTextParsing"],
