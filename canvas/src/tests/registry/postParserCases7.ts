...
["visualAnnotation.run.artifactOnce","@/__tests__/visualAnnotationEngine.test","testVisualAnnotationRunDelegatesArtifactOnce"],
  ...
  ["canvas.gameFps.runReady.canonicalSource","@/__tests__/gameFpsRunReadyContract.test","testGameFpsRunReadyRegistryUsesCanonicalSourceDocument"],
  ["canvas.gameFps.runReady.singleThreeCanvas","@/__tests__/gameFpsRunReadyContract.test","testGameFpsRunReadySurfaceReusesSingleThreeCanvas"],
  ["canvas.gameFps.runReady.browserSmokeContract","@/__tests__/gameFpsRunReadyContract.test","testGameFpsBrowserSmokeContractIsLocalAndInteractive"],
