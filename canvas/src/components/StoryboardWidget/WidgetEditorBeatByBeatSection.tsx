...
import { pad2, parseBeatIndexFromNodeId, readBeatRefFromParams } from '@/components/StoryboardWidget/beatByBeat'
import { FLOW_WIDGET_BEAT_WIRING_COLUMN_STYLES, FLOW_WIDGET_BEAT_WIRING_ROW_LAYOUT } from '@/components/StoryboardWidget/widgetEditorTableLayout'
...
export const WidgetEditorBeatByBeatSection = React.memo(function WidgetEditorBeatByBeatSection(props: {
  node: GraphNode
  ...
  const overlayNodeId = nodeId.startsWith('WIDGET_') ? nodeId : beatIndex != null ? `WIDGET_${pad2(beatIndex)}` : ''
