...
import { WidgetEditorKvTable } from '@/components/StoryboardWidget/WidgetEditorKvTable'
...
export const WidgetEditorParamsSection = React.memo(function WidgetEditorParamsSection({
  active,
  properties,
  microLabelClass,
  monospaceTextClass,
