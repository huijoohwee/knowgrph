...
export const FLOATING_MENU_BUTTON_CLASSNAME = ['w-full text-left px-2 py-1.5 rounded text-xs cursor-pointer', UI_THEME_TOKENS.button.hoverBg].join(' ')
...
export const FLOATING_MENU_BUTTON_DANGER_CLASSNAME = ['w-full text-left px-2 py-1.5 rounded text-xs cursor-pointer border border-red-200 text-red-600', UI_THEME_TOKENS.button.dangerHoverBg].join(' ')
