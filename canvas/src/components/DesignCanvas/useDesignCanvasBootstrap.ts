    ...
    useShallow(state => {
      if (!active) {
        return {
          ...
          setCanvasPointerMode2d: state.setCanvasPointerMode2d,
          ...
          commitDesignFrameRectHistory: state.commitDesignFrameRectHistory,
          commitDesignFramePosHistory: state.commitDesignFramePosHistory,
          commitDesignFrameSizeHistory: state.commitDesignFrameSizeHistory,
          undoDesignHistory: state.undoDesignHistory,
          redoDesignHistory: state.redoDesignHistory,
