...
import type { InspectorTab } from '@/components/StoryboardWidget/StoryboardWidgetInspector'
import { safeJsonStringify } from '@/components/StoryboardWidget/storyboardWidgetJson'
import type { GraphData, GraphEdge, GraphNode } from '@/lib/graph/types'

export function useStoryboardWidgetInspectorState(args: {
  active: boolean
