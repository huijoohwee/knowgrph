import { shouldUseStoryboardWidgetFloatingScreenAuthority } from '@/lib/storyboardWidget/widgetPlacementAuthority'
...
export function syncFlowWidgetScreenAuthorityPosition(args: {
  ...
  if (!shouldUseStoryboardWidgetFloatingScreenAuthority({ graphMetaKind: args.graphMetaKind, pinnedInCanvas })) return false
