...
│  ████ ████ ████  ☻   ████ ████ ████ ████ ████ ████  │  ← lone warrior moving
│  ████ ████ ████ ████ ████ ████ ████ ████ ████ ████  │
│                 ↑ amber vault light raking from top  │
└─────────────────────────────────────────────────────┘
```
...
│  ╱╲  ╱ MAST ╲  ╱╲ broken rigging ╱╲             │
│  ≋≋≋≋≋≋≋≋≋≋≋≋≋≋≋≋≋≋≋≋≋≋≋≋≋≋≋≋≋≋≋≋≋≋≋≋≋≋≋≋         │
│  [crew:frozen] [crew:frozen]  ☻  [crew:frozen]      │  ← warrior passes through
│  ≋≋≋≋≋≋≋≋≋≋≋ ship deck planks ≋≋≋≋≋≋≋≋≋≋≋         │
...
┌─────────────────────────────────────────────────────┐
│                  ☀ NOON ☀                           │
│  [gunslinger A]  ←──── •bullet ────→  [gunslinger B]│
│                         ↑                           │
│              ☻  warrior passes through               │
│  ═══════════════ main street dust ══════════════    │
│  ← long shadows │ heat shimmer post                 │
│  → camera push (into warrior's back)                 │
└─────────────────────────────────────────────────────┘
```
...
│  ████████████████████████████████████  ← trench wall│
│  [frozen:soldier] [frozen:soldier]                   │
│  ░░░ mud ░░░  ☻→→  ║▓▓▓▓▓FIRE▓▓▓▓▓║  ☻ emerges    │
│  ████████████████████████████████████               │
│  ← rack focus: warrior → fire wall → warrior         │
└─────────────────────────────────────────────────────┘
```
...
│  ══════════════ blue laser grid ══════════════      │
│                                                      │
│  ☻ warrior →               [ENDOSKELETON]           │
│                              ◉ red eye               │
│                              ↓                       │
│                           [KNEELS]                   │
│  → camera slow push toward endoskeleton              │
└─────────────────────────────────────────────────────┘
```
...
```
┌─────────────────────────────────────────────────────┐
│  ✦ stars ✦ ✦ stars ✦ ✦ stars ✦ ✦ ← through arches  │
│  ║           ║           ║  alien archways           │
│       ◈ bioluminescent teal light from monolith      │
│                                                      │
│  ☻ warrior →→→ ║█MONOLITH█║                         │
│                 ↑ clay hand dissolving upward ↑      │
│                 ✦ ✦ light particles ✦ ✦             │
│  → push in → cut to ECU on hand contact             │
└─────────────────────────────────────────────────────┘
```
...
│   [SHIP]──────[WEST]──────[TRENCH]                  │
│      \                        /                      │
│       \──────[WARRIOR◉]──────/  ← cursor hovers     │
│              /        \                              │
│         [T-800]──────[PROMETHEUS]                   │
│                                                      │
│  ← luminous bezier edges · nodes glow on canvas     │
│  ← exponential zoom-out from ECU                    │
└─────────────────────────────────────────────────────┘
```
...
│  ░░░░░░░░░░░░ DARK CANVAS ░░░░░░░░░░░░░░░░░░░░░░   │
│                                                      │
│          [node graph · subtle parallax]              │
│                                                      │
│   "Six thousand years of stories.                   │
│    One canvas to build them all."                    │
│                                                      │
│   airvio.co — SeeDance 2.0.                         │
│   Every model. Every era. Yours.                     │
│                                                      │
│   ← Cormorant Garamond · Light · fade 2s            │
└─────────────────────────────────────────────────────┘
```
